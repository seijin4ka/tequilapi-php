...
/**
 * PaymentOrderOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentOrderOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentOrderOptions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('suggested', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets suggested
     *
     * @param float[]|null $suggested suggested
     *
     * @return self
     */
    public function setSuggested($suggested)
    {
        if (is_null($suggested)) {
            throw new \InvalidArgumentException('non-nullable suggested cannot be null');
        }
