 ...
 */
class AccessPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'allow' => '\OpenAPI\Client\Model\AccessRule[]',
        'description' => 'string',
        'id' => 'string',
        'title' => 'string'
    ];
    ...
    */
     ...
     * Gets allow
     *
     * @return \OpenAPI\Client\Model\AccessRule[]|null
     */
     ...
     * Sets allow
     *
     * @param \OpenAPI\Client\Model\AccessRule[]|null $allow allow
     *
     * @return self
     */
